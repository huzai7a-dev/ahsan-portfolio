        ...
        <div className={style.sidebar} style={{ left: sidebarShow ? 0 : "-250px" }}>
            <div className="picture">
                ...
                <div className={style.social__icons__container}>
                    <a href="https://www.facebook.com/ahsan.jawed.104" target="_blank" rel="noreferrer">
                        <FaFacebookSquare className={style.sidebar__icons} />
                    </a>
                    <a href="https://github.com/Ahsan-J/" target="_blank" rel="noreferrer">
                        <FaGithubSquare className={style.sidebar__icons} />
                    </a>
                    <a href="https://www.linkedin.com/in/ahsan-ahmed-5b6b5382/" target="_blank" rel="noreferrer">
